...
def main() -> None:
    ...
    spells_combined: Callable = spell_combiner(Spells.basic_heal,
                                               Spells.fireball)
    print(spells_combined("Dragon"))

    print("\nTesting power amplifier...")
    amplified_spell: Callable = power_amplifier(Spells.dragon_flame, 3)
    print(amplified_spell(50, "Sonic"))

    print("\nTesting conditional caster...")
    cond_dragon: Callable = conditional_caster(Spells.valid_target,
                                               Spells.dragon_flame)
    print(cond_dragon("Trump", 9999))
    print(cond_dragon("Erika", 9999))

    print("\nTesting spell sequence...")
    spells: list[Callable] = [Spells.dragon_flame,
                              Spells.hydro_pump,
                              Spells.spin_dash]
